...
(
    ...
    visibility   varchar(32) default 'private'      not null comment '应用可见范围：public/private',
    tags         varchar(1024)                      null comment '应用标签，英文逗号包裹存储',
    ...
    INDEX idx_visibility (visibility),   -- 提升公开/私有应用过滤性能
