...
import { BookOutlined, BuildOutlined, PictureOutlined, ShoppingOutlined } from '@ant-design/icons-vue'
...
const searchFeaturedByTag = () => {
  // 切换标签筛选时回到第一页，避免当前页码超过筛选后的总页数。
    ...
    <div class="container">
      ...
      <div class="section">
        ...
        <div class="tag-search">
          <a-input-search
            v-model:value="featuredTag"
            placeholder="输入标签筛选"
            allow-clear
            @search="searchFeaturedByTag"
            @change="!featuredTag && searchFeaturedByTag()"
          />
        </div>
