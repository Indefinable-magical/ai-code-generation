...
/**
 * 工作流应用（模拟状态流转）
 * 学习提示：这是一个可直接 main 运行的工作流演示，用真实节点串起完整生成流程，主要用于本地理解 LangGraph4j。
 */
@Slf4j
public class WorkflowApp {

    public static void main(String[] args) throws GraphStateException {
        // 创建工作流图：节点代表处理步骤，边代表步骤之间的流转顺序。
        ...
        // 初始化 WorkflowContext - 只设置基本信息；后续节点会不断补充图片、生成类型、代码路径等字段。
